...
package hanto.studentcjn;

import hanto.common.*;
import hanto.studentcjn.beta.BetaHantoGame;
import hanto.studentcjn.delta.DeltaHantoGame;
import hanto.studentcjn.epsilon.EpsilonHantoGame;
import hanto.studentcjn.gamma.GammaHantoGame;
	...
	public static HantoGame makeHantoGame(HantoGameID gameId, HantoPlayerColor movesFirst) {
		...
		switch (gameId) {
			...
			case EPSILON_HANTO:
				...
				break;
		default:
			new HantoException("Game ID doesn't exist! : makeHantoGame failed");
		}
		return game;
	}
}
